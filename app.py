...
app_name = ttk.Label(app, text='Поисковое приложение',font='verdana 24 bold ', foreground='light green',background='light yellow')


app_name.grid(row=0,column=1)

search_label = ttk.Label(app, text='Поиск-->',background='light yellow')
